<template xmlns:v-on="http://www.w3.org/1999/xhtml" xmlns:v-bind="http://www.w3.org/1999/xhtml">
  <div>
    <el-col :span="24" class="breadcrumb-container">
       <div class="title">作业管理 / 散热设备统计管理</div>
    </el-col>
...
<script>
  ...
  var _this
  export default {
	  name: "cooler_maintain_statistics_manage",
	  components: {},
	  data () {
		  _this = this;
		  return {
			  userInfo: {},
			  queryDataUrl: HOME + "CoolerMaintainStatistics/getStatisticsData",
			  queryCountUrl: HOME + "CoolerMaintainStatistics/getRecordsCount",
			  deleteUrl: HOME + "CoolerMaintainStatistics/delete",
			  getStatisticsAtDateUrl: HOME + "CoolerMaintainStatistics/getStatisticsAtDate",
			  getAllTrainColumnUrl: HOME + "TrainColumn/getRecords",
			  editStatisticsAtDateUrl: HOME + "CoolerMaintainStatistics/editStatisticsAtDate",
			  listLoading: false,
			  form: {
				  formDate: [],
				  start_records: 0,
...
//			  _this.modifyForm.data.splice(this.deleteIndex, 1);
      ...
      onConfirmDelete(){
        ...
        $.ajax({
          ...
          type: 'POST',
          dataType: 'json',
				  data: _this.deletedItem,//_this.deletedItem,
          success: function (data) {
            if (data.status) {
              Notification({
                  title: '成功',
