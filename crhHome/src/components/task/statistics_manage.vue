<template xmlns:v-on="http://www.w3.org/1999/xhtml" xmlns:v-bind="http://www.w3.org/1999/xhtml">
  <div>
    <el-col :span="24" class="breadcrumb-container">
       <div class="title">作业管理 / 滤网布工作量管理</div>
    </el-col>
  ...
  export default {
    ...
    data () {
      ...
      return {
        ...
        getStatisticsAtDateUrl:HOME + "statistics/getStatisticsAtDate",
        getAllTrainColumnUrl:HOME + "TrainColumn/getRecords",
        editStatisticsAtDateUrl:HOME + "statistics/editStatisticsAtDate",
