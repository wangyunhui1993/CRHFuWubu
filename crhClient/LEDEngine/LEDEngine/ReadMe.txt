========================================================================
    ACTIVE TEMPLATE LIBRARY : LEDEngine Project Overview
========================================================================

AppWizard has created this LEDEngine project for you to use as the starting point for
...
LEDEngine.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (LEDEngine.h)
        GUID definitions                                (LEDEngine_i.c)
        A type library                                  (LEDEngine.tlb)
        Marshaling code                                 (LEDEngine_p.c and dlldata.c)

LEDEngine.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in LEDEngine.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named LEDEngine.pch and a precompiled types file named StdAfx.obj.
...
LEDEngineps.vcxproj
	...
	dlldata.c, LEDEngine_i.c and LEDEngine_p.c which are required
	to build the proxy/stub DLL.

LEDEngineps.vcxproj.filters
